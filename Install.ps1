...
if (((Test-Path -Path "AppxManifest.xml","Assets","CustomInstall","Fonts","Images","Microsoft.UI.Xaml.winmd","NV12toRGBPixelShader.cso","PassthroughVertexShader.cso","RGBPassthroughPixelShader.cso","Registry.dat","Styles","Tools","WSACodecs.dll","WSACrashUploader","WsaClient","WsaProxy","WsaService","WsaSettings.exe","WsaSettings.winmd","WsaSettingsBroker","appcompatdb.json","classicAppInstaller_WSA.sccd","gfxstream_backend.dll","libEGL.dll","libGLESv2.dll","lxutil.dll","product.img","resources.pri","system.img","system_ext.img","userdata.vhdx","vclibs.appx","vendor.img","wslcore.dll","wsldeps.dll","wsldevicehost.dll","wslhost.exe","xaml.appx") -eq $false).Count) {
